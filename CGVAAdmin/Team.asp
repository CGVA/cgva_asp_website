...
<td valign='top'>
	...
	Sub modifyRecord()
		...
		SQL = "SELECT  a.TEAM_ID, "_
			...
			& "WHERE c.ACTIVE_EVENT_IND IN ('Y','A') "_
			& "ORDER BY 	UPPER(EVENT_SHORT_DESC), DIVISION_DESC"
		rw("<!-- SQL: " & SQL & " -->")
		Set rs = cn.Execute(SQL)
	...
	''		End If
		...
		%>
				...
				<td><input type="text" id="TEAM_CD<%=rs("TEAM_ID")%>" name="TEAM_CD" value="<%=rs("TEAM_CD")%>" size='4' maxlength='4' disabled></td>
	...
	%>
		...
		<tr>
		<td align='right' valign='middle'><font size='2' face='arial'><b>TEAM CODE</b></font></td>
		<td><input type="text" name='TEAM_CD' size='4' maxlength='4'></td>
		</tr>

		<tr>
		<td align='right' valign='middle'><font size='2' face='arial'><b>TEAM NAME</b></font></td>
