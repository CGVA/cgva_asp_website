...
''	End If
	...
	sql = 	"SELECT EVENT_CD, " & _
			...
			"EVENT_LONG_DESC " & _
			"FROM EVENT_TBL " & _
			"ORDER BY EVENT_END_DATE DESC, EVENT_SHORT_DESC, EVENT_LONG_DESC"
	...
	<td align="left" valign="top">
		...
		<td align="left" valign="top">
			...
			<td align='left'>
				...
				<option value="MVP"<% If Session("TYPEOFREPORT") = "MVP" Then rw(" SELECTED") %>>Event MVP</option>
				<option value="xxx"<% If Session("TYPEOFREPORT") = "xxx" Then rw(" SELECTED") %>></option>
				<option value="REF"<% If Session("TYPEOFREPORT") = "REF" Then rw(" SELECTED") %>>Certified Refs</option>
				</select>
			</td>
			</tr>
