...
<%
	...
	DEBUG = TRUE  'set this to TRUE to debug'
	...
	Case "SCHEDULE"
		...
		WEB_PROC_VARS = "@EVENT_CD='" & vEVENT & "'"
	Case "MVP"
		Session("showname") = "Event MVP"
		WEB_PROC_NAME = "MVP"
		WEB_PROC_VARS = "@EVENT_CD='" & vEVENT & "'"
	Case "REF"
		Session("showname") = "Certified Refs"
		WEB_PROC_NAME = "REF_RPT"
		''WEB_PROC_VARS = "@EVENT_CD='" & vEVENT & "'"
	Case Else
...
<%
	...
	Sub WebReport()
		...
		rw("<td>")
			...
			If Session("TYPEOFREPORT")="MVP" Then

				rw("<font class='cfont10'>")
				rw("<ul>")

				rw("<li>For a 2-Team Division:</li>")
                rw("<li>The MVP is the highest vote getter from the 1st place team in the tournament.</li>")
                rw("<li>Medals are awarded to the 1st place team.</li>")


				rw("<li>For a 3, 4- or 5-Team Division:</li>")
                rw("<li>The MVP is the highest vote getter from the 1st or 2nd place team in the tournament.</li>")
                rw("<li>Medals are awarded to the 1st place team for a 3 team division.</li>")
                rw("<li>Medals are awarded to the 1st and 2nd place teams for a 4 or 5 team division.</li>")

				rw("<li>For Divisions with 6 Teams or More:</li>")
				rw("<li>The MVP is the highest vote getter from any team with a winning percentage over 0.500 or the 1st, 2nd, or 3rd place team in the tournament.</li>")
                rw("<li>Medals are awarded to the 1st, 2nd and 3rd place teams.</li>")

				rw("<li>In the event of a tie, the player on the team that finishes higher in the tournament is considered the MVP.</li>")
				rw("</ul>")
				rw("</font>")
			...
			rw("<td valign='top'>")
				...
				Case "REGISTRATION","CONTACTS","RATINGS","FASTLANE","TEAM","SCHEDULE","MVP","REF"
					...
					for i = 0 to rsRows
						...
						For j = 0 to rsCols
							rw("<td valign='top' bgcolor=""" & BGCOLOR & """><font class='cfont10'>" & rsData(j, i) & "</font></td>")
						Next
...
rw("<tr height='20' bgcolor='#FFFFFF'><td></td></tr>")
%>
	...
	Sub ExcelReport()
		...
		Case "REGISTRATION","CONTACTS","RATINGS", "FASTLANE","TEAM","SCHEDULE","MVP","REF"
			If Session("TYPEOFREPORT")="MVP" Then
				...
				rw("<font class='cfont10'>")
				rw("<ul>")
				rw("<li>For a 4- or 5-Team Division:</li>")
				rw("<li>The MVP is the highest vote getter from the 1st or 2nd place team in the tournament.</li>")
			...
			for i = 0 to rsRows
				...
				For j = 0 to rsCols
					rw("<td valign='top'><font face='arial' size='2'>" & rsData(j, i) & "</font></td>")
				Next
