...
<td valign='top'>
	...
	''		End If
		...
		%>
				...
				<tr bgcolor="<%=BGCOLOR%>">
				<td align='center'>
					<input type="hidden" id="ID<%=rs("PERSON_ID")%>" name="ID" value="<%=rs("PERSON_ID")%>" />
					<font class='cfont10'><%=rs("PERSON_ID")%></font>
				</td>
				<td>
					<input type="text" id="FIRST_NAME<%=rs("PERSON_ID")%>" name="FIRST_NAME" value="<%=rs("FIRST_NAME")%>" size='25' maxlength='25'>
				</td>
				<td>
					<input type="text" id="LAST_NAME<%=rs("PERSON_ID")%>" name="LAST_NAME" value="<%=rs("LAST_NAME")%>" size='25' maxlength='35'></td>
				<td>
					<input type="text" id="PHOTO_FILENAME<%=rs("PERSON_ID")%>" name="PHOTO_FILENAME" value="<%=rs("PHOTO_FILENAME")%>" size='20' maxlength='100'>
				</td>
				<td>
					<input type="text" id="EMAIL<%=rs("PERSON_ID")%>" name="EMAIL" value="<%=rs("EMAIL")%>" size='30' maxlength='50'>
				</td>
				<td>
					<input type="text" id="BIRTH_DATE<%=rs("PERSON_ID")%>" name="BIRTH_DATE" value="<%=rs("BIRTH_DATE")%>" size='10' maxlength='10'>
				</td>
