...
<td valign='top'>
	...
	Sub modifyRecord()
		...
		sql = "SELECT 		a.PERSON_ID, a.FIRST_NAME, a.LAST_NAME, b.CERT_ID, "_
			...
			& "AND	 		(b.EFF_DATE IS NULL OR b.EFF_DATE = (SELECT MAX(EFF_DATE) FROM REFEREE_CERTIFICATION_TBL WHERE PERSON_ID = a.PERSON_ID)) "_
	...
	''		End If
		...
		%>
				...
				<td valign='top' align='center'><textarea id="ID<%=rsPlayerRefData(0,i)%>" name="NOTES"><%=rsPlayerRefData(5,i)%></textarea></td>
				</tr>
