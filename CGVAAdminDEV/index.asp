			...
			If rsDataRows > -1 Then
				...
				For i = 0 to rsDataRows
					...
					If CStr(DIVISION_ID) = CStr(rsData(0,i)) then
						rw("<td><a class='menuBlack' href='index.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & rsData(0,i) & "'><img src='../images/" & rsData(2,i) & "_down.gif' border='0' name='d" & i & "' id='d" & i & "' alt='' onmouseover=""imgRollover('d" & i & "')"" onmouseout=""imgDown('d" & i & "')"" /></a></td>")
					Else
						rw("<td><a class='menuBlack' href='index.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & rsData(0,i) & "'><img src='../images/" & rsData(2,i) & "_up.gif' border='0' name='d" & i & "' id='d" & i & "' alt='' onmouseover=""imgRollover('d" & i & "')"" onmouseout=""imgUp('d" & i & "')"" /></a></td>")
					End If
				...
				If DIVISION_ID <> "" Then
					...
					Case "SCHEDULE",""
						rw("<td><a class='menuBlack' href='index.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=SCHEDULE'><img src='../images/schedule_2.gif' border='0' name='cSchedule' id='cSchedule' alt='' onmouseover=""imgRollover1('cSchedule')"" onmouseout=""imgDown2('cSchedule')"" /></a></td>")
					...
					Case "STANDINGS"
						rw("<td><a class='menuBlack' href='index.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=SCHEDULE'><img src='../images/schedule_0.gif' border='0' name='cSchedule' id='cSchedule' alt='' onmouseover=""imgRollover1('cSchedule')"" onmouseout=""imgUp0('cSchedule')"" /></a></td>")
