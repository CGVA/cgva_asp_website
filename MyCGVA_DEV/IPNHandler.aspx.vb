...
Partial Class IPNHandler
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If strResponse = "VERIFIED" Then
            ...
            'process payment
            emailSubject = "VERIFIED - CGVA 2013 VOLLEYPALOOZA REGISTRATION"
            Try
            ...
            Try
                ...
                VP = aryTextFile(1) '8/3/2012 now holds the value of the event code
                ...
                'If VP = "on" Then
                SQL = "If not exists(select PERSON_ID from REGISTRATION_TBL where PERSON_ID='" & personID & "' and EVENT_CD='" & VP & "' and REGISTRATION_IND='Y') " _
        ...
        ElseIf strResponse = "INVALID" Then
            ...
            emailSubject = "INVALID - CGVA 2013 VOLLEYPALOOZA REGISTRATION"
        ...
        Else
            ...
            emailSubject = "Response not VERIFIED or INVALID - CGVA 2013 VOLLEYPALOOZA REGISTRATION"
            Try
                aryTextFile = Request.Form("custom").Split("~")
