...
<td valign='top' width='100%'>
	...
	<td height='20'></td>
        ...
        &nbsp;<asp:DropDownList ID="leagueChoiceDropDownList" runat="server" autopostback="true">
         </asp:DropDownList>
            </font>   
        </td></tr>
        ...
        <td align="right">
            ...
            <asp:HiddenField ID="item_name" value="2013 Volleypalooza" runat="server" />
            <asp:HiddenField ID="return" value="http://cgva.org/MyCGVA_DEV/MyEvents6.aspx" runat="server" />
