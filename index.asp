...
<%
	...
	If Request("SCHEDULE_CHOICE") <> "" Then
		SCHEDULE_CHOICE = Request("SCHEDULE_CHOICE")
		Session("SCHEDULE_CHOICE") = SCHEDULE_CHOICE
	Else
		 if Session("SCHEDULE_CHOICE") = "" then
		 	Session("SCHEDULE_CHOICE") = "REMAINING"
		end if

		SCHEDULE_CHOICE = Session("SCHEDULE_CHOICE")
	End If
	...
	SQL = 	"select EVENT_CD, EVENT_SHORT_DESC,LOCATION_DESC,EVENT_IMG from EVENT_TBL a " & _
			...
			"WHERE ACTIVE_EVENT_IND IN ('Y','W') " & _
			"ORDER BY EVENT_END_DATE DESC, EVENT_START_DATE, EVENT_CD"
...
<!--
	...
	var mycgva = new Image();
	mycgva.src = "images/mycgva_0.gif";

	var mycgva_on = new Image();
	mycgva_on.src = "images/mycgva_1.gif";

	var mycgva_off = new Image();
	mycgva_off.src = "images/mycgva_2.gif";
	...
	var lastdig = new Image();
	lastdig.src = "images/lastdig_0.gif";

	var lastdig_on = new Image();
	lastdig_on.src = "images/lastdig_1.gif";

	var lastdig_off = new Image();
	lastdig_off.src = "images/lastdig_2.gif";
	...
	aboutus.src = "images/aboutus_0.gif";

	var aboutus_on = new Image();
	aboutus_on.src = "images/aboutus_1.gif";

	var aboutus_off = new Image();
	aboutus_off.src = "images/aboutus_2.gif";
	...
	matchmate.src = "images/matchmate_0.gif";

	var matchmate_on = new Image();
	matchmate_on.src = "images/matchmate_1.gif";

	var matchmate_off = new Image();
	matchmate_off.src = "images/matchmate_2.gif";


	var contactus = new Image();
	contactus.src = "images/contactus_0.gif";

	var contactus_on = new Image();
	contactus_on.src = "images/contactus_1.gif";

	var contactus_off = new Image();
	contactus_off.src = "images/contactus_2.gif";
...
*/
	...
	function updateScheduleChoice()
	{
		...
		//alert(choice);
		redirectLocation = "index.asp?EVENT_CD=<%=EVENT_CD%>&DIVISION_ID=<%=DIVISION_ID%>&CHOICE=SCHEDULE&SCHEDULE_CHOICE=" + choice;
...
<table bgcolor='#000066'  align='center' border='0' cellpadding='0' cellspacing='0'>
<tr>
			...
			If rsDataRows > -1 Then
				...
				For i = 0 to rsDataRows
					...
					If CStr(DIVISION_ID) = CStr(rsData(0,i)) then
						rw("<td><a class='menuBlack' href='index.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & rsData(0,i) & "&SORT=" & SORT & "'><img src='../images/" & rsData(2,i) & "_down.gif' border='0' name='d" & i & "' id='d" & i & "' alt='' onmouseover=""imgRollover('d" & i & "')"" onmouseout=""imgDown('d" & i & "')"" /></a></td>")
					Else
						rw("<td><a class='menuBlack' href='index.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & rsData(0,i) & "&SORT=" & SORT & "'><img src='../images/" & rsData(2,i) & "_up.gif' border='0' name='d" & i & "' id='d" & i & "' alt='' onmouseover=""imgRollover('d" & i & "')"" onmouseout=""imgUp('d" & i & "')"" /></a></td>")
					End If
				...
				If DIVISION_ID <> "" Then
					...
					Case "SCHEDULE",""
						rw("<td><a class='menuBlack' href='index.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=SCHEDULE&SCHEDULE_CHOICE=" & Session("SCHEDULE_CHOICE") & "&SORT=" & SORT & "'><img src='../images/schedule_2.gif' border='0' name='cSchedule' id='cSchedule' alt='' onmouseover=""imgRollover1('cSchedule')"" onmouseout=""imgDown2('cSchedule')"" /></a></td>")
						rw("<td><a class='menuBlack' href='index.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=STANDINGS'><img src='../images/standings_0.gif' border='0' name='cStandings' id='cStandings' alt='' onmouseover=""imgRollover1('cStandings')"" onmouseout=""imgUp0('cStandings')"" /></a></td>")
						rw("<td><a class='menuBlack' href='index.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=TEAMS'><img src='../images/teams_0.gif' border='0' name='cTeams' id='cTeams' alt='' onmouseover=""imgRollover1('cTeams')"" onmouseout=""imgUp0('cTeams')"" /></a></td>")
					...
					Case "STANDINGS"
						rw("<td><a class='menuBlack' href='index.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=SCHEDULE&SCHEDULE_CHOICE=" & Session("SCHEDULE_CHOICE") & "&SORT=" & SORT & "'><img src='../images/schedule_0.gif' border='0' name='cSchedule' id='cSchedule' alt='' onmouseover=""imgRollover1('cSchedule')"" onmouseout=""imgUp0('cSchedule')"" /></a></td>")
						rw("<td><a class='menuBlack' href='index.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=STANDINGS'><img src='../images/standings_2.gif' border='0' name='cStandings' id='cStandings' alt='' onmouseover=""imgRollover1('cStandings')"" onmouseout=""imgDown2('cStandings')"" /></a></td>")
						rw("<td><a class='menuBlack' href='index.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=TEAMS'><img src='../images/teams_0.gif' border='0' name='cTeams' id='cTeams' alt='' onmouseover=""imgRollover1('cTeams')"" onmouseout=""imgUp0('cTeams')"" /></a></td>")
						rw("<td><a class='menuBlack' target='_blank' href='tournament/" & EVENT_CD & "_" & DIVISION_ID & ".asp'><img src='../images/tournament_0.gif' border='0' name='cTournament' id='cTournament' alt='' onmouseover=""imgRollover1('cTournament')"" onmouseout=""imgUp0('cTournament')"" /></a></td>")
					...
					Case "TEAMS"
						rw("<td><a class='menuBlack' href='index.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=SCHEDULE&SCHEDULE_CHOICE=" & Session("SCHEDULE_CHOICE") & "&SORT=" & SORT & "'><img src='../images/schedule_0.gif' border='0' name='cSchedule' id='cSchedule' alt='' onmouseover=""imgRollover1('cSchedule')"" onmouseout=""imgUp0('cSchedule')"" /></a></td>")
						rw("<td><a class='menuBlack' href='index.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=STANDINGS'><img src='../images/standings_0.gif' border='0' name='cStandings' id='cStandings' alt='' onmouseover=""imgRollover1('cStandings')"" onmouseout=""imgUp0('cStandings')"" /></a></td>")
						rw("<td><a class='menuBlack' href='index.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=TEAMS'><img src='../images/teams_2.gif' border='0' name='cTeams' id='cTeams' alt='' onmouseover=""imgRollover1('cTeams')"" onmouseout=""imgDown2('cTeams')"" /></a></td>")
						rw("<td><a class='menuBlack' target='_blank' href='tournament/" & EVENT_CD & "_" & DIVISION_ID & ".asp'><img src='../images/tournament_0.gif' border='0' name='cTournament' id='cTournament' alt='' onmouseover=""imgRollover1('cTournament')"" onmouseout=""imgUp0('cTournament')"" /></a></td>")
					Case "TOURNAMENT"
						rw("<td><a class='menuBlack' href='index.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=SCHEDULE&SCHEDULE_CHOICE=" & Session("SCHEDULE_CHOICE") & "&SORT=" & SORT & "'><img src='../images/schedule_0.gif' border='0' name='cSchedule' id='cSchedule' alt='' onmouseover=""imgRollover1('cSchedule')"" onmouseout=""imgUp0('cSchedule')"" /></a></td>")
						rw("<td><a class='menuBlack' href='index.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=STANDINGS'><img src='../images/standings_0.gif' border='0' name='cStandings' id='cStandings' alt='' onmouseover=""imgRollover1('cStandings')"" onmouseout=""imgUp0('cStandings')"" /></a></td>")
	...
	<%If EVENT_DESC <> "" Then%>
		...
		<%Else
			...
			Case "SCHEDULE",""
				...
				rw("<tr bgcolor=""#FF3300"" height='12'>")
				rw("<td valign='top'>")
					rw("<table border='0' width='100%'>")
					rw("<tr>")
					rw("<td valign='top'><font class='cfontWhite12'>" & EVENT_DESC & " @ " & LOCATION_DESC & " - " & DIVISION_CD & " - Schedule</td>")
					rw("<td valign='top' align='right'><form name='FORM'><select name='SCHEDULE_CHOICE' onChange='updateScheduleChoice();'>")
			...
			Case "STANDINGS"
				...
				if not rs.EOF then
					if CInt(rs(0)) = 0 then
						...
						rw("<td height=""14""><font class='cfontWhite12'>" & EVENT_DESC & " @ " & LOCATION_DESC & " - " & DIVISION_CD & " - Standings</td>")
						rw("</tr>")

					else
						rw("<tr bgcolor=""#FF3300"">")
						rw("<td height=""14""><font class='cfontWhite12'>" & EVENT_DESC & " @ " & LOCATION_DESC & " - " & DIVISION_CD & " - Standings as of Week " & rs(0) & "</td>")
						rw("</tr>")
...
<%
			...
			Case "TEAMS"
				...
				rw("<tr bgcolor=""#FF3300"">")
				rw("<td height=""14""><font class='cfontWhite12'>" & EVENT_DESC & " @ " & LOCATION_DESC & " - " & DIVISION_CD & " - Teams</td>")
				rw("</tr>")
...
<%
			...
			Case "TOURNAMENT"
				...
				rw("<tr bgcolor=""#FF3300"">")
				rw("<td height=""14""><font class='cfontWhite12'>" & EVENT_DESC & " @ " & LOCATION_DESC & " - " & DIVISION_CD & " - Tournament</td>")
				rw("</tr>")
			...
			Case Else
				rw("<tr bgcolor=""#FF3300"">")
				rw("<td height=""14""><font class='cfontWhite12'>" & EVENT_DESC & " @ " & LOCATION_DESC & "</td>")
				rw("</tr>")
