...
Partial Class PayPalLASTDIG
    ...
    Protected item_name As String = "2014 Last Dig In Denver Registration"
    Protected item_number As String = ""    'used to hold person ID of the transaction

    Protected amount As String = ""
    'JPC TEST'
    Protected return_url As String = "http://cgva.org/lastdigindenver/RegistrationSuccess.aspx"
    Protected notify_url As String = "http://cgva.org/lastdigindenver/IPNHandler.aspx"
    'JPC TEST'
    Protected cancel_url As String = "http://cgva.org/lastdigindenver/registrationCancel.aspx"
