...
Partial Class IPNHandler
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If strResponse = "VERIFIED" Then
            ...
            'process payment
            emailSubject = "VERIFIED - " & Request.Form("custom").ToString & " CGVA 2011 LAST DIG REGISTRATION"
            Try
        ...
        ElseIf strResponse = "INVALID" Then
            ...
            emailSubject = "INVALID - " & Request.Form("custom").ToString & " CGVA 2011 LAST DIG REGISTRATION"
        ...
        Else
            ...
            emailSubject = "Response not VERIFIED or INVALID - " & Request.Form("custom").ToString & " CGVA 2011 LAST DIG REGISTRATION"
