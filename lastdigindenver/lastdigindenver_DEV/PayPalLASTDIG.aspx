...
<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PayPalLASTDIG.aspx.vb" Inherits="PayPalLASTDIG" %>
...
<body>
    <!--<form id="payForm" method="post" action="<'%'Response.Write (URL)'%'>"  target="paypal">-->
    <form id="payForm" method="post" action="<%Response.Write (URL)%>" target="_top">
