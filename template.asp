			...
			If rsDataRows > -1 Then
				...
				For i = 0 to rsDataRows
					...
					If CStr(DIVISION_ID) = CStr(rsData(0,i)) then
						rw("<td><a class='menuBlack' href='template.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & rsData(0,i) & "'><img src='../images/" & rsData(2,i) & "_down.gif' border='0' name='d" & i & "' id='d" & i & "' alt='' onmouseover=""imgRollover('d" & i & "')"" onmouseout=""imgDown('d" & i & "')"" /></a></td>")
					Else
						rw("<td><a class='menuBlack' href='template.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & rsData(0,i) & "'><img src='../images/" & rsData(2,i) & "_up.gif' border='0' name='d" & i & "' id='d" & i & "' alt='' onmouseover=""imgRollover('d" & i & "')"" onmouseout=""imgUp('d" & i & "')"" /></a></td>")
					End If
				...
				If DIVISION_ID <> "" Then
					...
					Case "SCHEDULE",""
						rw("<td><a class='menuBlack' href='template.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=SCHEDULE'><img src='../images/schedule_2.gif' border='0' name='cSchedule' id='cSchedule' alt='' onmouseover=""imgRollover1('cSchedule')"" onmouseout=""imgDown2('cSchedule')"" /></a></td>")
						rw("<td><a class='menuBlack' href='template.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=STANDINGS'><img src='../images/standings_0.gif' border='0' name='cStandings' id='cStandings' alt='' onmouseover=""imgRollover1('cStandings')"" onmouseout=""imgUp0('cStandings')"" /></a></td>")
						rw("<td><a class='menuBlack' href='template.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=TEAMS'><img src='../images/teams_0.gif' border='0' name='cTeams' id='cTeams' alt='' onmouseover=""imgRollover1('cTeams')"" onmouseout=""imgUp0('cTeams')"" /></a></td>")
					...
					Case "STANDINGS"
						rw("<td><a class='menuBlack' href='template.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=SCHEDULE'><img src='../images/schedule_0.gif' border='0' name='cSchedule' id='cSchedule' alt='' onmouseover=""imgRollover1('cSchedule')"" onmouseout=""imgUp0('cSchedule')"" /></a></td>")
						rw("<td><a class='menuBlack' href='template.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=STANDINGS'><img src='../images/standings_2.gif' border='0' name='cStandings' id='cStandings' alt='' onmouseover=""imgRollover1('cStandings')"" onmouseout=""imgDown2('cStandings')"" /></a></td>")
						rw("<td><a class='menuBlack' href='template.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=TEAMS'><img src='../images/teams_0.gif' border='0' name='cTeams' id='cTeams' alt='' onmouseover=""imgRollover1('cTeams')"" onmouseout=""imgUp0('cTeams')"" /></a></td>")
						rw("<td><a class='menuBlack' target='_blank' href='tournament/" & EVENT_CD & "_" & DIVISION_ID & ".asp'><img src='../images/tournament_0.gif' border='0' name='cTournament' id='cTournament' alt='' onmouseover=""imgRollover1('cTournament')"" onmouseout=""imgUp0('cTournament')"" /></a></td>")
					...
					Case "TEAMS"
						rw("<td><a class='menuBlack' href='template.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=SCHEDULE'><img src='../images/schedule_0.gif' border='0' name='cSchedule' id='cSchedule' alt='' onmouseover=""imgRollover1('cSchedule')"" onmouseout=""imgUp0('cSchedule')"" /></a></td>")
						rw("<td><a class='menuBlack' href='template.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=STANDINGS'><img src='../images/standings_0.gif' border='0' name='cStandings' id='cStandings' alt='' onmouseover=""imgRollover1('cStandings')"" onmouseout=""imgUp0('cStandings')"" /></a></td>")
						rw("<td><a class='menuBlack' href='template.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=TEAMS'><img src='../images/teams_2.gif' border='0' name='cTeams' id='cTeams' alt='' onmouseover=""imgRollover1('cTeams')"" onmouseout=""imgDown2('cTeams')"" /></a></td>")
						rw("<td><a class='menuBlack' target='_blank' href='tournament/" & EVENT_CD & "_" & DIVISION_ID & ".asp'><img src='../images/tournament_0.gif' border='0' name='cTournament' id='cTournament' alt='' onmouseover=""imgRollover1('cTournament')"" onmouseout=""imgUp0('cTournament')"" /></a></td>")
					Case "TOURNAMENT"
						rw("<td><a class='menuBlack' href='template.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=SCHEDULE'><img src='../images/schedule_0.gif' border='0' name='cSchedule' id='cSchedule' alt='' onmouseover=""imgRollover1('cSchedule')"" onmouseout=""imgUp0('cSchedule')"" /></a></td>")
						rw("<td><a class='menuBlack' href='template.asp?EVENT_CD=" & EVENT_CD & "&DIVISION_ID=" & DIVISION_ID & "&CHOICE=STANDINGS'><img src='../images/standings_0.gif' border='0' name='cStandings' id='cStandings' alt='' onmouseover=""imgRollover1('cStandings')"" onmouseout=""imgUp0('cStandings')"" /></a></td>")
	...
	<%If EVENT_DESC <> "" Then%>
		...
		<%Else
			...
			Case "SCHEDULE",""
				...
				rw("<td height=""14""><font class='cfontWhite14'>" & EVENT_DESC & " @ " & LOCATION_DESC & " - " & DIVISION_CD & " - Schedule</td>")
				rw("</tr>")
...
<%
			...
			Case "TOURNAMENT"
				...
				rw("<td>")
%>
				<!-- #include virtual="/incs/fragTournament.asp" -->
<%
				rw("</td>")
				rw("</tr>")
				''rw("</tr>")
